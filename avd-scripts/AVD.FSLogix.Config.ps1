...
Add-LocalGroupMember -Group "FSLogix Profile Include List" -Member (Get-ItemPropertyValue -Path "HKLM:\SOFTWARE\AVD" -Name "ProfileUsersGroup")
...
Add-LocalGroupMember -Group "FSLogix ODFC Include List" -Member (Get-ItemPropertyValue -Path "HKLM:\SOFTWARE\AVD" -Name "ProfileUsersGroup")
